...
export default function Footer5() {
    return (
        <>
            <footer className="footer-area padding-top footer-5 bg-30">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="single-footer mr50">
                                <Link href="/" className="footer-logo"> <img src="/assets/img/logo/home4-header-logo.svg" alt="" /></Link>
                            ...
                            <div className="single-footer">
                                ...
                                <div className="footer-contact">
                                    <div className="single-contact">
                                        ...
                                        <Link className="font-f-5" href="#">USA: +91 02 2585 0556</Link>
                                        <Link className="font-f-5" href="#">UK: +61 02 2585 0556</Link>
                                    </div>
                                </div>
                                <div className="footer-contact">
                                    <div className="single-contact">
